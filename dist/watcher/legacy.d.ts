import { providerType } from 'core/legacy';
...
export declare class Watcher<T = {
    [key: string]: unknown;
}, M = undefined, P = unknown> implements IWatcher<T, M, P> {
    savedProvider: P;
    sourceObj: T & (P | providerType<T, M>);
    SPECIAL_KEY: specialKeyLiteralType;
    broadcast: any;
...
export declare const watcherCreator: <T, M, P>(obj: T, provider?: P, methods?: M, broadcastName?: string) => Watcher<T, M, P>;
